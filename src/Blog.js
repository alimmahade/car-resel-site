  ...
  return (
    <div>
      <div className="max-w-md text-center">
        ...
        <p className="py-6">
          Question:-1. What is cors? Answer: CORS is a part of HTTP that lets
          servers specify any other hosts from which a browser should permit
          loading of content.
        </p>
        <p className="py-6">
          Question:-2. Why are you using firebase? Answer: Firebase helps you
        ...
        <p className="py-6">
          Question:-3. How does the private route work ? Answer: The private
          route component is similar to the public route, the only change is
          that redirect URL and authenticate condition. If the user is not
        ...
        <p className="py-6">
          Question:-4. What is node ? Answer: Node.js is an open-source,
